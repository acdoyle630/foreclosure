...
describe('foreclosure', function() {
  ...
  it.skip('should invoke the `loan` function and assign it\'s return value to the `stevesLoan` variable', function() {
  ...
  it.skip('should invoke the `borrower` function passing in the argument `stevesLoan` and assign it\'s return value to the variabl `steve`', function() {
  ...
  it.skip('should invoke the `steve.payDay` and `steve.makePayment` functions and increment `month` by `1` while `stevesLoan` is not foreclosed', function() {
  ...
  describe.skip('monthsUntilEvicted', function () {
